import gym
from jarmuiranyitas_1.f110_env.f110_gym.envs.base_classes import Simulator, Integrator
...
class F110Env(gym.Env):
    ...
    def render(self, mode='human'):
        ...
        if F110Env.renderer is None:
            ...
            from jarmuiranyitas_1.f110_env.f110_gym.envs.rendering import EnvRenderer
